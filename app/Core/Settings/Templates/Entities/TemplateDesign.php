...
class TemplateDesign
{
	public function getInvoiceHeading ()
	{
		...
		$productTitleHead = "
						...
						<tr style='height: 15px; text-align: left; background-color: transparent;'>
							<td class='tg-m36b thsrno' style='font-size: 12px; text-align: center; height: 15px; width: 5px; padding: 1px; border: 1px solid black; border-left: 0px;' colspan='1' rowspan='2'><strong>Sr. No</strong></td>
							<td class='tg-m36b theqp' style='font-size: 12px; padding: 2px; height: 15px; text-align: left; border: 1px solid black; border-right: 0px; border-left: 0px; max-width: 120px; overflow-wrap: break-word;' colspan='".($productColspan+2)."' rowspan='2'><strong>Perticular</strong></td>

							[extraColumn1]
							<td class='tg-ullm thsrno' style='font-size: 12px; padding: 2px; height: 15px; width: 10px; text-align: center; border: 1px solid black; border-right: 0px;' colspan='1' rowspan='2'><strong>Qty</strong></td>
							[extraColumn2]
							<td class='tg-ullm thsrno' style='font-size: 12px; padding: 2px; height: 15px; text-align: center; border: 1px solid black; border-right: 0px;' rowspan='2'><strong>Rate</strong></td>
							<td class='tg-ullm thamt' style='font-size: 12px; padding: 0px; height: 15px; text-align: center; border: 1px solid black; border-right: 0px; border-bottom: 0px;' colspan='2'><strong>Discount</strong></td>


							<td class='tg-ullm thamt' style='font-size: 12px; padding: 1px; height: 15px; text-align: center; border: 1px solid black; border-right: 0px; min-width: 50px;' colspan='3' rowspan='2'><strong>Amount</strong></td>
						</tr>
						<tr style='height: 15px; text-align: left; background-color: transparent;'>
							<td class='tg-ullm thamt' style='font-size: 12px; padding: 1px; height: 15px; text-align: center; border: 1px solid black; border-right: 0px; border-top: 0px;' colspan='1'><strong>Rate</strong></td>
							<td class='tg-ullm thamt' style='font-size: 12px; padding: 1px; height: 15px; text-align: center; border: 1px solid black; border-right: 0px; border-top: 0px;' colspan='1'><strong>Amount</strong></td>
		...
		$extraColumns = "<td class='tg-m36b theqp' style='font-size: 12px; padding: 2px; height: 15px; text-align: center; border: 1px solid black; border-right: 0px; overflow-wrap: break-word; max-width: 100px;' colspan='".$extraColumnColSpan."' rowspan='2'><strong>".$customLabel."</strong></td>";

		$productTitleHead = str_replace('[extraColumn1]', $extraColumns, $productTitleHead);

		$extraColumns = $unitColumn;

		$productTitleHead = str_replace('[extraColumn2]', $extraColumns, $productTitleHead);
