...
class QuotationController extends BaseController implements ContainerInterface
{
	...
	*/
    public function store(Request $request)
    {
		...
		$authenticationResult = $tokenAuthentication->authenticate($request->header(),'quotation.add');
	...
	*/
	public function update(Request $request,$quotationBillId)
	{
		//Authentication
		$tokenAuthentication = new TokenAuthentication();
		$authenticationResult = $tokenAuthentication->authenticate($request->header(),'quotation.edit');
	...
	*/
	public function destroySalesOrderData(Request $request,$saleId,$dataType = 'order')
	{
		//Authentication
		$tokenAuthentication = new TokenAuthentication();
		$authenticationResult = $tokenAuthentication->authenticate($request->header(),'quotation.delete');
